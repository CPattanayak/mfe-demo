 ...
 * ROLE_) so that @PreAuthorize("hasRole('product:write')") works on the
...
public class SecurityConfig {
    ...
    private ReactiveJwtAuthenticationConverterAdapter jwtAuthenticationConverter() {
        ...
        // setJwtGrantedAuthoritiesConverter expects a
        // Converter<Jwt, Collection<GrantedAuthority>> — a plain method
        // reference satisfies that fine. See KeycloakAuthorities' javadoc
        // for why a lambda/method reference can't target
        // JwtGrantedAuthoritiesConverter itself (it's a concrete class).
