...
# config.yaml itself + the 4 hand-written operation files (the same
# files docker-compose.qa.yml bind-mounts directly):
...
kubectl apply -f k8s/qa/apollo-mcp-server.yaml
kubectl apply -f k8s/qa/ai-gateway-service.yaml
